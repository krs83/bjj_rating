...
async def get_all_tournament_links(
    ...
    return await athlete_tournament_link_service.list_all_tournament_links(offset, limit)

@router.get("/athlete/link/id/{athlete_id}",
            response_model=list[AthleteTournamentLinkResponse],
            description="Получение списка турниров спортсмена по ID",
            summary="Get  athlete tournaments list links by ID")
async def get_athlete_tournament_links(
        athlete_tournament_link_service: athlete_tournament_link_serviceDP,
        athlete_id: int,
) -> list[AthleteTournamentLinkBase]:
    return await athlete_tournament_link_service.list_athlete_tournament_links_by_id(athlete_id)
...
async def post_athlete_tournament_link(
        athlete_tournament_link_service: athlete_tournament_link_serviceDP,
...
async def delete_athlete_tournament_link(athlete_tournament_link_service: athlete_tournament_link_serviceDP,
                                         athlete_id: int,
                                         tournament_id: int) -> bool:
    return await athlete_tournament_link_service.remove_athlete_tournament_link_by_id(athlete_id, tournament_id)
